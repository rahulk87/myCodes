...
rownames(mat1) <- make.names(mat1$gene, unique=TRUE)
...
## HK gene sets
spikes <- read.table("/Users/kumarr/work/common_files/HK_genes.txt", sep="\t", header=FALSE) ## change here for using different set of control genes
spikes <- spikes$V1
##########################
